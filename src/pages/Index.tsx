  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Braunschweig | Barberroom EG</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Barberroom EG in Braunschweig für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Barberroom EG | Premium Barbershop Braunschweig" />
        <meta
        ...
        <meta name="twitter:title" content="Barberroom EG | Premium Barbershop Braunschweig" />
        <meta
